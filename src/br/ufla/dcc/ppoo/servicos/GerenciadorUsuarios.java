...
import br.ufla.dcc.ppoo.dao.UsuarioDAO2;
...
public class GerenciadorUsuarios {
    ...
    public void autenticarUsuario(Usuario usuario) throws Exception {
        Usuario usuarioCadastrado = 
                repositorioUsuario.buscarUsuarioLogin(usuario.obterLogin());
    ...
    public void cadastrarUsuario(Usuario usuario) throws Exception {
        Usuario ret = repositorioUsuario.buscarUsuarioLogin(usuario.obterLogin());
        if (ret != null) {
